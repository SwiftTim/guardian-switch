...
import { Shield, Mail, Lock, UserPlus, ChevronRight, Loader2, Terminal, Cpu } from "lucide-react";
            ...
            <div className="w-full max-w-[420px] relative z-10">
                <div className="flex flex-col items-center text-center mb-10">
                    <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 mb-4 animate-fade-in shadow-sm backdrop-blur-sm">
                        ...
                        <span className="text-[10px] font-mono font-bold tracking-widest uppercase text-primary">system_initialize_v1</span>
                    </div>
                    <h1 className="text-3xl font-bold font-mono tracking-tighter mb-2 glow-text">
                        CREATE_SECURE_NODE
                    </h1>
                    <p className="text-foreground/60 text-sm">Deploy your fail-safe monitoring system</p>
                </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-6 relative">
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>
                                    INITIALIZE_ACCOUNT <ChevronRight className="w-4 h-4 translate-x-0 group-hover/btn:translate-x-1 transition-transform" />
                                </>
                            )}
                        </Button>
                    </form>
                ...
                <p className="mt-8 text-center text-xs font-mono text-foreground/40 tracking-tight">
                    EXISTING_AUTH_FOUND? {" "}
                    <Link href="/login" className="text-primary hover:text-secondary transition-colors font-bold decoration-primary/30 underline underline-offset-4">
                        LOGIN_SECURELY
                    </Link>
                </p>
