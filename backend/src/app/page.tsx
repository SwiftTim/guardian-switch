...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 overflow-hidden">
      ...
      {/* Hero Section */}
      <main className="relative z-10 mx-auto max-w-6xl px-6 pt-24 pb-32 md:pt-40">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold font-mono tracking-tighter mb-8 max-w-4xl glow-text leading-[1.1]">
            THE_ULTIMATE <br />
          ...
          <p className="max-w-2xl text-lg md:text-xl text-foreground/60 mb-12 leading-relaxed">
            ...
            Simple. Secure. Autonomous.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/dashboard">
              <Button className="font-mono h-12 px-10 text-base flex items-center gap-2">
                INITIALIZE_SYSTEM <ChevronRight className="w-4 h-4" />
              </Button>
            </Link>
            <Button variant="outline" className="font-mono h-12 px-10 text-base">
              VIEW_PROTOCOLS
            </Button>
          </div>
        </div>
